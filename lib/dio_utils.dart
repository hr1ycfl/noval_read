...
class DioUtils {
  ...
  /// default options
  static const int CONNECT_TIMEOUT = 150000;
  ...
  static void getHttp<T>(String url,
      {Map<String, dynamic>? parameters, Function? onSuccess}) async {
    ///定义请求参数
    ...
    try {
      ...
      if (response.statusCode == 200 && onSuccess != null) {
        ...
        throw Exception(
            'responseCode:${response.statusCode},responseData:$responseData');
      }
    } catch (e) {
      rethrow;
    }
  ...
  ///Post请求
  static void postHttp<T>(String url,
      {Map<String, dynamic>? parameters, Function? onSuccess}) async {
    ///定义请求参数
    parameters = parameters ?? <String, dynamic>{};
  ...
  static void requestHttp<T>(String url,
      {parameters, method, Function? onSuccess, Function? onError}) async {
    ...
    if (method == DioUtils.GET) {
      ...
      postHttp(url, parameters: parameters, onSuccess: (data) {
        if (onSuccess != null) {
          onSuccess(data);
        }
      });
  ...
  static String gbkDecoder(List<int> responseBytes, RequestOptions options,
    ...
    if (type.contains("gb")) {
      ...
      try {
        return const Utf8Decoder().convert(responseBytes);
      } catch (e) {
        return gbk.decode(responseBytes);
      }
    }
...
Map<String, dynamic> httpHeaders = {
  AppConst.UA_NAME: AppConst.UA_VALUE,
};
